    ...
    languages: {
        'en': {
            consent_modal: {
                ...
                description: 'Notre site internet et les sociétés partenaires utilisent des cookies. Ces cookies nous permettent de personnaliser votre expérience utilisateur, mesurer l’audience, collecter des statistiques de visite pour l’optimisation de la publicité et l’amélioration des contenus. Vous pouvez gérer vos préférences des cookies, accepter ou refuser le dépôt de l’ensemble des cookies. Un lien &quot;Gérer mes cookies&quot; sur notre site vous permet également de modifier vos choix à tout moment. <button type="button" data-cc="c-settings">Show cookie settings</button><br><button type="button" data-cc="accept-all">Accept all cookies</button><br><button type="button" data-cc="accept-necessary">Reject All</button',
                primary_btn: {
                    text: 'Accept all',
